    ...
    <div className="modal-content">
      ...
      <div className="modal-footer border-0">
       ...
       <div className="row row-cols-2 col-12">
        ...
        <button className="btn" style={{position:'relative',left:'7px',border:'solid 0.1px lightgrey'}}  type="button"><img style={{height: 'auto',width: '11%'}} src='/facebook.svg'/> <span style={{fontSize:'15px', fontWeight:'600'}}>Sign up with Facebook</span></button>
        <button className="btn" style={{position:'relative',left:'7px',border:'solid 0.1px lightgrey'}} type="button"><img style={{    height: 'auto',width: '7%'}} src='/google.svg'/> <span style={{fontSize:'15px', fontWeight:'600'}} >Sign up with Google</span></button>
        </div>
